...
public class Player extends Entity{
    ...
    public void getPlayerImage() {
        ...
        try {
            up1 = ImageIO.read(getClass().getResourceAsStream("/player/bear_up_1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/player/bear_up_2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/player/bear_down_1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/player/bear_down_2.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/player/bear_right_1.png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/player/bear_right_2.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/player/bear_left_1.png"));
